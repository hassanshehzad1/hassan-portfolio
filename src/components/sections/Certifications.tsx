            ...
            <div className="grid grid-cols-1 md:grid-cols-3 gap-6">
              {featuredCertifications.map((cert) => (
                <div
                  ...
                  className="bg-gradient-to-br from-gray-900 to-gray-800 border-2 border-white/20 rounded-lg overflow-hidden hover:border-white/40 transition-all cursor-pointer group focus:outline-none focus:ring-2 focus:ring-white"
                  tabIndex={0}
                  role="button"
        ...
        <div className="grid grid-cols-1 md:grid-cols-2 lg:grid-cols-3 gap-6">
          {filteredCertifications.map((cert) => (
            <div
              ...
              className="bg-gray-900/50 border border-gray-800 rounded-lg overflow-hidden hover:border-gray-700 transition-colors cursor-pointer focus:outline-none focus:ring-2 focus:ring-white"
              tabIndex={0}
              role="button"
              aria-label={`View details for ${cert.title}`}
            >
